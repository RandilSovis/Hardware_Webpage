                ...
                <div class="collapse navbar-collapse navHeadercollapse">
                    <div class="header-bottom">
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li><a class="active" href="transportation.php">TRANSPORTATION</a></li>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading"> <strong class="">Transportation</strong>

                            </div>
                            <div class="panel-body">
                <h2>1 cube Lorry</h2>
            <img src="images/149851679_176595144268096_6306251880706572759_n.jpg"width="500" height="370" alt="New Item Name" />  
            <h2>4 cube Lorry</h2>
            <img src="images/7.jpg"width="500" height="370" alt="New Item Name" />                      
                        </div>
                    </div>  
                </div>
            </div>
