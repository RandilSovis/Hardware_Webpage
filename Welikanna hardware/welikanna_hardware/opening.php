                ...
                <div class="collapse navbar-collapse navHeadercollapse">
                    <div class="header-bottom">
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li><a class="active" href="opening.php">OPENING</a></li>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading"> <strong class="">Opening</strong>

                            </div>
                            <div class="panel-body">
            <table>
                <caption>Opening hours of Wellikanna Hardware</caption>
                <tr>
                    <th></th>
                    <th>Monday</th>
                    <th>Tuesday</th>
