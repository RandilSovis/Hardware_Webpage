                    ...
                    <div class="col-md-6 col-md-offset-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" action="signupprocess.php" method="POST">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">First Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="first name" required="" name="fn">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="mob" placeholder="mobile" required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="panel-footer">Already have a account? <a href="login.php" class="">Sign in here</a>
                            </div>
                        </div>
                    </div>
                </div>
